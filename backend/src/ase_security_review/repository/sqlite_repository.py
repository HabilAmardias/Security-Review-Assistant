...
def _review_to_row(review: Review) -> dict:
    return {
        ...
        "pipeline": review.pipeline or None,
        "current_stage": review.current_stage or None,
        "analysis_json": json.dumps(review.analysis) if review.analysis else None,
        "diagram_paths_json": json.dumps(review.diagram_paths) if review.diagram_paths else None,
